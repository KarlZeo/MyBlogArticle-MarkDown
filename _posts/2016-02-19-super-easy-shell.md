...
id: 38
title: 超级好用的Shell
date: 2016-02-19T21:32:53+08:00
author: Kanaan Austen
layout: post
guid: https://blog.nieyujiang.info/?p=38
permalink: /2016/02/19/super-easy-shell/
dsq_thread_id:
  - 4670377712
views:
  - 12
...
<pre class="prettyprint" ><code>wget https://github.com/robbyrussell/oh-my-zsh/raw/master/tools/install.sh -O - | sh
</code></pre>

手动安装：

<pre class="prettyprint" ><code>git clone git://github.com/robbyrussell/oh-my-zsh.git ~/.oh-my-zsh
cp ~/.zshrc ~/.zshrc.orig
...
<pre class="prettyprint" ><code>Customize to your needs…
</code></pre>
...
<pre class="prettyprint" ><code>alias cls='clear'
alias ll='ls -l'
alias la='ls -a'
alias vi='vim'
...
<pre class="prettyprint" ><code>PROMPT='%{$fg_bold[red]%}➜ %{$fg_bold[green]%}%p%{$fg[cyan]%}%d %{$fg_bold[blue]%}$(git_prompt_info)%{$fg_bold[blue]%}% %{$reset_color%}&gt;'
...
<pre class="prettyprint" ><code>plugins=(git textmate ruby autojump osx mvn gradle)
</code></pre>
